...
def run_onboarding_wizard():
    """Assistant d'onboarding interactif utilisant questionary et rich."""
    console.print(Panel.fit("[bold cyan]🛡️ Sentinel CLI — Assistant de Configuration Initial (sentinel init)[/bold cyan]", border_style="cyan"))
    ...
    adapter_choice = questionary.select(
        ...
        choices=[
            ...
            "⚙️ Configurer un adaptateur personnalisé"
        ]
    ).ask()
